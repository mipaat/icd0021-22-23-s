...
namespace App.DAL.EF.Migrations.Postgres
{
    ...
    [Migration("20230520011702_ScopeReduceAndEntityCategories")]
    partial class ScopeReduceAndEntityCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.EntityAccessPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.AuthorCategory", b =>
                {
                    b.HasOne("App.Domain.Author", "AssignedBy")
                        .WithMany("AssignedAuthorCategories")
            ...
            modelBuilder.Entity("App.Domain.PlaylistCategory", b =>
                {
                    b.HasOne("App.Domain.Author", "AssignedBy")
                        .WithMany("AssignedPlaylistCategories")
                        .HasForeignKey("AssignedById")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("App.Domain.Author", b =>
                {
                    b.Navigation("AssignedAuthorCategories");

                    b.Navigation("AssignedPlaylistCategories");
